<template>
    <vxe-table border class="mytable-style merge-style-3" :header-cell-class-name="headerCellClassName"  :column-config="{ resizable: true }" :row-config="{ isHover: true }"
...
.merge-style-3 .vxe-body--row:nth-child(1){
    background-color: #1e88e5;
    color: #fff;
}
.merge-style-3 .vxe-body--row:nth-child(2){
    background-color: #1e88e5;
    color: #fff;
}
.merge-style-3 .vxe-body--row:nth-child(3){
    background-color: #1e88e5;
    color: #fff;
}
</style>
